...
QCoro::Task<void> client::sendNetworkMessage(QString host, quint16 port, QString message)
{
    ...
    qDebug() << "Starting connection with the host and port ...";
    ...
    bool ok = co_await qCoro(&socket).waitForConnected();
    ...
    //co_await qCoro(&socket).waitForBytesWritten()
    ...
    QMessageBox::information(
        ...
        "Your message has been sent successfully!", // Main text
